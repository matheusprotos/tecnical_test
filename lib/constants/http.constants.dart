class HTTPConstants {
  ...
  static const int SWITCHING_PROTOCOL = 101;
  ...
  static const int MULTI_STATUS_DAV = 208;
  static const int I_AM_USED = 226;
  ...
  static const int TEMPORARY_REDIRET = 307;
  static const int PERMANENT_REDIRET = 308;
